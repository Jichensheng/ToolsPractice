...
import com.jcs.snackbar.behavior.AppBarLayoutOverScrollViewBehavior;
import com.jcs.snackbar.fragment.ItemFragment1;
import com.jcs.snackbar.fragment.MyFragmentPagerAdapter;
import com.jcs.snackbar.fragment.TabEntity;
import com.jcs.snackbar.widget.CircleImageView;
import com.jcs.snackbar.widget.NoScrollViewPager;
import com.jcs.snackbar.widget.RoundProgressBar;
...
public class Demo1Activity extends AppCompatActivity {
    ...
    private void initListener() {
        ...
        mAppBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                //titleCenterLayout为头像和标题布局，mAvater为头像 mSettingIv为设置按钮，mMsgIv为消息按钮
    ...
    /**
     * 初始化toolbar和layout_uc_head_title位置，让他向下偏移一个状态栏的高度
     */
     ...
     *
     * @param alpha
     * @param state 0-正在变化 1展开 2 关闭 根据折叠百分比
     */
