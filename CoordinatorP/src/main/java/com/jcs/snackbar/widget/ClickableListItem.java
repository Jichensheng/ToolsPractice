...
public class ClickableListItem extends LinearLayout {
    ...
    public ClickableListItem(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ClickableListItem);
    ...
    private void init() {
        ...
        if (clickable) {
            ...
            iv.setImageDrawable(ContextCompat.getDrawable(getContext(),R.drawable.ic_pre_point_normal));
